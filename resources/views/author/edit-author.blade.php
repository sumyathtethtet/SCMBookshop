...
<div class="container">
    <div class="col-md-8 my-4">
        <h3 class="mb-5">Author Detail</h3>
            <form class="form-horizontal" method="POST" action="/update-author" enctype="multipart/form-data">
                {{ csrf_field() }}

            <input type="hidden" name="postid" value="{{$authoredit_id->id}}">
                <div class="form-group row">
                    <label for="name" class="col-md-4 control-label">Name</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" placeholder="Enter Author Name" name="name" value="{{$authoredit_id->name}}">
                            @if ($errors->has('name'))
